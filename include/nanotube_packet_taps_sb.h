 /**************************************************************************\
*//*! \file nanotube_packet_taps_sb.h
** \author  Neil Turton <neilt@amd.com>
**  \brief  Simple Bus interface for Nanotube packet taps.
**   \date  2020-09-23
*//*
\**************************************************************************/
...
#ifndef NANOTUBE_PACKET_TAPS_SB_H
#define NANOTUBE_PACKET_TAPS_SB_H

/**
** The functions below implement the "abstract" prototypes from the
** include/nanotube_packet_taps.h file.  Have a look there for more detailed
** explanation about the functionality of each tunfction here.
**/
...
/*! The simple bus wrapper of the length tap.
**/
...
/*! The simple bus wrapper of the read tap.
**/
...
/*! The simple bus wrapper of the write tap.
**/
...
/*! The simple bus wrapper of the resize tap ingress stage.
**
...
**  contain the output packet word.  This word is only valid of
...
**
** \param state_packet_word A pointer to  a static buffer containing enough
**  space for storing a packet word (packet_word_len bytes).
**
...
/*! Check whether a simple bus packet word denotes the end of packet.
**
** This is a specialisation of the generic nanotube_tap_packet_is_eop function
** for simple bus packet words.
**
...
#endif // NANOTUBE_PACKET_TAPS_SB_H
