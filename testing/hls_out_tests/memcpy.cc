...
**  \brief  A test which uses memcpy from a static buffer.
**   \date  2021-10-28
*//*
\**************************************************************************/
...
static const uint8_t buffer[] = { 0x11, 0x22, 0x33, 0x44, 0x55, 0x66 };
...
void logic_0(nanotube_context_t* context, void *arg)
{
  ...
  memcpy(word.bytes + sizeof(simple_bus::header), buffer, sizeof(buffer));
