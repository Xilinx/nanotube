...
entry:
  tail call void @nanotube_add_plain_packet_kernel(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), void (%struct.nanotube_context*, %struct.nanotube_packet*)* nonnull @kernel.1, i32 0, i32 1) #3
  ret void
}
...
; Function Attrs: nounwind uwtable
define private void @kernel.1(%struct.nanotube_context* nocapture readnone %context, %struct.nanotube_packet* %packet) #0 {
entry:
  ...
  %call = call i64 @nanotube_packet_read(%struct.nanotube_packet* %packet, i8* nonnull %0, i64 1, i64 14) #3
  %call2 = call i64 @nanotube_packet_write(%struct.nanotube_packet* %packet, i8* nonnull %0, i64 1, i64 14) #3
