...
@nanotube_malloc_buf = global [4 x i8] zeroinitializer
...
entry:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 getelementptr inbounds ([4 x i8], [4 x i8]* @nanotube_malloc_buf, i8 0, i8 0), i8* align 1 %0, i64 4, i1 false)
  call void @nanotube_thread_create(%struct.nanotube_context* %call, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), void (%struct.nanotube_context*, i8*)* nonnull @stage_0.1, i8* nonnull null, i64 0) #3
...
; Function Attrs: nounwind uwtable
define private void @stage_0.1(%struct.nanotube_context* nocapture readnone %ctxt, i8* nocapture readonly %data) #0 {
entry:
  %0 = bitcast i8* getelementptr inbounds ([4 x i8], [4 x i8]* @nanotube_malloc_buf, i8 0, i8 0) to i32*
