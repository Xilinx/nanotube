...
entry:
  %0 = load i8*, i8** @pointer_0, align 8, !tbaa !5
  %1 = load i8, i8* @x, align 1, !tbaa !2
  %tobool = icmp eq i8 %1, 0
  br i1 %tobool, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %2 = load volatile i8*, i8** @pointer_1, align 8, !tbaa !5
  br label %if.end

if.end:                                           ; preds = %entry, %if.then
  %p.0 = phi i8* [ %2, %if.then ], [ %0, %entry ]
  %arrayidx = getelementptr inbounds i8, i8* %p.0, i64 1
  store i8 42, i8* %arrayidx, align 1, !tbaa !2
  %3 = load i8, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @buffer, i64 0, i64 0), align 1, !tbaa !2
  store i8 %3, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @result, i64 0, i64 0), align 1, !tbaa !2
  %4 = load i8, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @buffer, i64 0, i64 1), align 1, !tbaa !2
  store i8 %4, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @result, i64 0, i64 1), align 1, !tbaa !2
  %5 = load i8, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @buffer, i64 0, i64 2), align 1, !tbaa !2
  store i8 %5, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @result, i64 0, i64 2), align 1, !tbaa !2
  %6 = load i8, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @buffer, i64 0, i64 3), align 1, !tbaa !2
  store i8 %6, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @result, i64 0, i64 3), align 1, !tbaa !2
