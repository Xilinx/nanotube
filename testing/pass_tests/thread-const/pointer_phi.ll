...
@buffer = dso_local local_unnamed_addr global [4 x i8] zeroinitializer, align 1
...
if.end:                                           ; preds = %entry, %if.then
  %p.0 = phi i8* [ getelementptr inbounds ([4 x i8], [4 x i8]* @buffer, i64 0, i64 2), %if.then ], [ getelementptr inbounds ([4 x i8], [4 x i8]* @buffer, i64 0, i64 1), %entry ]
  store i8 42, i8* %p.0, align 1, !tbaa !2
  %1 = load i8, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @buffer, i64 0, i64 0), align 1, !tbaa !2
  store i8 %1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @result, i64 0, i64 0), align 1, !tbaa !2
  %2 = load i8, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @buffer, i64 0, i64 1), align 1, !tbaa !2
  store i8 %2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @result, i64 0, i64 1), align 1, !tbaa !2
  %3 = load i8, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @buffer, i64 0, i64 2), align 1, !tbaa !2
  store i8 %3, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @result, i64 0, i64 2), align 1, !tbaa !2
  %4 = load i8, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @buffer, i64 0, i64 3), align 1, !tbaa !2
  store i8 %4, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @result, i64 0, i64 3), align 1, !tbaa !2
  tail call void @nanotube_thread_wait() #2
  ret void
}
