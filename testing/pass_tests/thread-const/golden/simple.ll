...
entry:
  store i32 42, i32* @result_int, align 4, !tbaa !6
  store i32* bitcast (i8* getelementptr inbounds (i8, i8* bitcast ([64 x i32]* @buffer to i8*), i64 44) to i32*), i32** @result_ptr, align 8, !tbaa !2
