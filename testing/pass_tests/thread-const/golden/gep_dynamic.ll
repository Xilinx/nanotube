...
if.end:                                           ; preds = %if.then, %entry
  %p.0 = phi %struct.entry* [ bitcast (i8* getelementptr inbounds (i8, i8* getelementptr inbounds ([4 x %struct.entry], [4 x %struct.entry]* @buffer, i32 0, i32 0, i32 0), i64 2) to %struct.entry*), %if.then ], [ getelementptr inbounds ([4 x %struct.entry], [4 x %struct.entry]* @buffer, i32 0, i32 0), %entry ]
  ...
  %0 = load i8, i8* getelementptr inbounds ([4 x %struct.entry], [4 x %struct.entry]* @buffer, i64 0, i64 0, i32 0), align 1, !tbaa !2
  store i8 %0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @result, i64 0, i64 0), align 1, !tbaa !9
  store i8 11, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @result, i64 0, i64 1), align 1, !tbaa !9
  %1 = load i8, i8* getelementptr inbounds ([4 x %struct.entry], [4 x %struct.entry]* @buffer, i64 0, i64 1, i32 0), align 1, !tbaa !2
  store i8 %1, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @result, i64 0, i64 2), align 1, !tbaa !9
  store i8 13, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @result, i64 0, i64 3), align 1, !tbaa !9
  %2 = load i8, i8* getelementptr inbounds ([4 x %struct.entry], [4 x %struct.entry]* @buffer, i64 0, i64 2, i32 0), align 1, !tbaa !2
  store i8 %2, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @result, i64 0, i64 4), align 1, !tbaa !9
  store i8 15, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @result, i64 0, i64 5), align 1, !tbaa !9
  %3 = load i8, i8* getelementptr inbounds ([4 x %struct.entry], [4 x %struct.entry]* @buffer, i64 0, i64 3, i32 0), align 1, !tbaa !2
  store i8 %3, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @result, i64 0, i64 6), align 1, !tbaa !9
  store i8 17, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @result, i64 0, i64 7), align 1, !tbaa !9
