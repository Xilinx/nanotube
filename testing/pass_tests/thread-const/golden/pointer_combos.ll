...
entry:
  %add.ptr = getelementptr inbounds i8, i8* @buffer_0, i64 1
  store i8* %add.ptr, i8** @result_0, align 8, !tbaa !2
  %add.ptr1 = getelementptr inbounds i8, i8* getelementptr inbounds (i8, i8* @buffer_0, i64 1), i64 1
  store i8* %add.ptr1, i8** @result_1, align 8, !tbaa !2
  %add.ptr2 = getelementptr inbounds i8, i8* bitcast (i32* @buffer_1 to i8*), i64 1
  store i8* %add.ptr2, i8** @result_2, align 8, !tbaa !2
  %add.ptr3 = getelementptr inbounds i8, i8* getelementptr inbounds (i8, i8* bitcast (i32* @buffer_1 to i8*), i64 4), i64 1
  store i8* %add.ptr3, i8** @result_3, align 8, !tbaa !2
  %add.ptr4 = getelementptr inbounds i32, i32* bitcast (i8* @buffer_0 to i32*), i64 1
  store i32* %add.ptr4, i32** @result_4, align 8, !tbaa !2
  %add.ptr5 = getelementptr inbounds i32, i32* bitcast (i8* getelementptr inbounds (i8, i8* @buffer_0, i64 1) to i32*), i64 1
  store i32* %add.ptr5, i32** @result_5, align 8, !tbaa !2
  %add.ptr6 = getelementptr inbounds i32, i32* @buffer_1, i64 1
  store i32* %add.ptr6, i32** @result_6, align 8, !tbaa !2
  %add.ptr7 = getelementptr inbounds i32, i32* bitcast (i8* getelementptr inbounds (i8, i8* bitcast (i32* @buffer_1 to i8*), i64 4) to i32*), i64 1
