...
@buffer = common dso_local global i8 0, align 1
@pointer_0 = common dso_local global i8* null, align 8
...
@result_1 = common dso_local local_unnamed_addr global i8 0, align 1

; Function Attrs: nounwind uwtable
define dso_local void @nanotube_setup() local_unnamed_addr #0 {
entry:
  store i8* @buffer, i8** @pointer_0, align 8, !tbaa !2
  store i8** @pointer_0, i8*** @pointer_1, align 8, !tbaa !2
...
entry:
  %0 = load i8**, i8*** @pointer_1, align 8, !tbaa !2
  %1 = load i8*, i8** %0, align 8, !tbaa !2
  %2 = load i8, i8* %1, align 1, !tbaa !6
  store i8 %2, i8* @result_0, align 1, !tbaa !6
  %3 = load i8*, i8** @pointer_0, align 8, !tbaa !2
  %4 = load i8, i8* %3, align 1, !tbaa !6
  store i8 %4, i8* @result_1, align 1, !tbaa !6
  store i8** @pointer_0, i8*** @pointer_1, align 8, !tbaa !2
