...
entry:
  %0 = load i8, i8* bitcast (i32* @buffer_0 to i8*), align 4, !tbaa !6
  store i8 %0, i8* @result_0, align 1, !tbaa !6
  %1 = load i32, i32* bitcast ([4 x i8]* @buffer_1 to i32*), align 1, !tbaa !2
  store i32 %1, i32* @result_1, align 4, !tbaa !2
  ret void
}
